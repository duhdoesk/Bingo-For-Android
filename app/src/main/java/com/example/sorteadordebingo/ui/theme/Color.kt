...
//COMMON COLORS
val grid_background = Color(0x12707070)
val white = Color(0xFFFFFFFF)
val black = Color(0xFF000000)
val light_error = Color(0xFFBA1A1A)
val dark_error = Color(0xFFFFB4AB)

val green_200 = Color(0xffc0ffa4)
val green_300 = Color(0xffa1ff78)
val green_400 = Color(0xff82ff50)
val green_500 = Color(0xff62fd1a)
val green_600 = Color(0xff4dea0c)
val green_700 = Color(0xff22d400)
val green_800 = Color(0xff00bf00)
val green_900 = Color(0xff009b00)

val complementary = Color(0xffCD50FF)
